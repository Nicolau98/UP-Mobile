...
namespace UP_Mobile.Controllers
{
    public class AdministradoresController : Controller
    {
        ...
        public AdministradoresController(UPMobileContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdAdministrador,Nome,DataNascimento,Morada,Contacto,Email,LocalTrabalho")] Administrador administrador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdAdministrador,Nome,DataNascimento,Morada,Contacto,Email,LocalTrabalho")] Administrador administrador)
        {
